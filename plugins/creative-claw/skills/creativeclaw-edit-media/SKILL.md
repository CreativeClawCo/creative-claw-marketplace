...
- Mixing narration with music, ducking, crossfades, moving crops, or exact caption-file rendering require additional capabilities. State the specific missing operation before creating assets that cannot be assembled as requested.

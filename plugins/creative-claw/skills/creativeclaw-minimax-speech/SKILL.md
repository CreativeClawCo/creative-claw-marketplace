---
name: creativeclaw-minimax-speech
description: "Apply MiniMax Speech 2.8 HD multilingual voice casting, global emotion, pacing, pronunciation, and sound-tag guidance after Creative Claw selects speech/minimax-hd. Use when the user requests MiniMax speech or needs a native system voice for a supported language."
---
...
Use this model specialist inside `creativeclaw-generate-voiceover`. MiniMax is the strongest alternative when a native system voice, broad multilingual catalog, or global emotion/pitch controls matter more than ElevenLabs v3's line-level delivery tags.

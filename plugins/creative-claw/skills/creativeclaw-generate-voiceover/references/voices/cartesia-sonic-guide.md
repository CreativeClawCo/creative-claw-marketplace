...
Read [shared execution guidance](../workflow-basics.md) once per task before using tools. It covers model discovery, optional cost checks, imports, and recovery.
